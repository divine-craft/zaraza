...
import ru.divinecraft.zaraza.common.paper.api.player.PlayerViewed;
...
public interface Sidebar<L extends Sidebar.@NotNull Line> extends PlayerViewed {
     ...
     */
    Flow.@NotNull Publisher<@NotNull TextModel<@NotNull Player>> title();
    ...
    interface Line {
         ...
         */
        Flow.@NotNull Publisher<@NotNull TextModel<@NotNull Player>> text();
         ...
         */
        Flow.@NotNull Publisher<@NotNull Integer> value();
    }
